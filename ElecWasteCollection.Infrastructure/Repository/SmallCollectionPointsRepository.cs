...
{
	public class SmallCollectionPointsRepository : GenericRepository<SmallCollectionPoints>, ISmallCollectionPointsRepository
    {
		public SmallCollectionPointsRepository(DbContext context) : base(context)
		{
		}
