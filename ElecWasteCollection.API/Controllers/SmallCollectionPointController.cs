...
namespace ElecWasteCollection.API.Controllers
{
	...
	[Authorize]
	[Route("api/smallCollectionPoint")]
    [ApiController]
    public class SmallCollectionPointController : ControllerBase
    {
        private readonly ISmallCollectionPointsService _smallCollectionService;
		private readonly IExcelImportService _excelImportService;
		public SmallCollectionPointController(ISmallCollectionPointsService smallCollectionService, IExcelImportService excelImportService)
		{
